...
export const Icons = {
  ...
  globe: ph(GlobeIcon),
  // Profile & sessions
  checkCircle: ph(CheckCircleIcon),
  circle: ph(CircleIcon),
  shieldCheck: ph(ShieldCheckIcon),
  key: ph(KeyIcon),
  devices: ph(DevicesIcon),
  laptop: ph(LaptopIcon),
  desktop: ph(DesktopIcon),
  mobile: ph(DeviceMobileIcon),
  // Actions & states
